...
abstract class BaseFragmentSharedVM <VB: ViewBinding, VM: ViewModel>(private val inflater: Inflater<VB>, private val viewModelClass: Class<VM>): BaseFragment<VB>(inflater) {
